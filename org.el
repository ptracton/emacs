...
;;
;; Minting the src code in ORG mode
;; https://joonro.github.io/blog/posts/org-mode-outputdir-minted-latex-export.html
;;
...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/Agenda/refile.org")
              ...
              ("n" "note" entry (file "~/Agenda/refile.org")
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+datetree "~/Agendadiary.org")
               "* %?\n%U\n" :clock-in t :clock-resume t)
